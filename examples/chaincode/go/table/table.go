...
// This chaincode implements a simple table that is stored in the state.
// The following operations are available.

// Invoke operations
// createTable - requires two arguments, a table name and columns
// deleteTable - requires a table name
// addRow      - requires a key and value columns
// updateRow   - requires a key and value columns
// deleteRow   - requires a key

// Query operations
// getRow   - requires one argument, a key, and returns a row
// getRows
...
func (t *SimpleChaincode) Invoke(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
	...
	case "createTable":
		...
		err := stub.Create(key, []byte(value))
		if err != nil {
